    ...
    <div id="tx-detail-container" className="flex flex-col min-h-full bg-slate-100 text-slate-900 pb-16">
      ...
      <div className="p-4 max-w-md mx-auto w-full space-y-4">
        <button
          ...
          className="w-full bg-white border border-emerald-500 text-emerald-700 font-bold py-2 rounded-xl flex items-center justify-center gap-2 hover:bg-emerald-50"
        >
          📄 Export PDF Digital Handshake
        </button>

        <div id="kontrak" className="space-y-4">
        ...
        <div id="tx-commodity-card" className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-500 flex flex-col gap-1 mt-1">
                <span className="flex items-center gap-1">
                  <MapPin className="w-3 h-3 text-slate-400" /> {order.location}
                </span>
                <span className="text-[10px] text-slate-400">Titik Koordinat: -6.879, 109.032 (Estimasi)</span>
              </div>
            </div>
          </div>
